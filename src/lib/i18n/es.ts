...
export const es = {
  ...
  phase2: {
    ...
    chatEmpty:
      "Pregunta sobre tu código o sobre la sintaxis de C. Opus responderá directamente a las preguntas de sintaxis, y con contrapreguntas cuando preguntes sobre tu propio enfoque.",
    you: "tú",
    opus: "opus",
    thinking: "pensando…",
